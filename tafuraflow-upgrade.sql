-- TafuraFlow upgrade: private invitation links, owner phone, company controls and owner payments.
-- Run this after the original TafuraFlow database SQL. This upgrade is safe to run again when a newer website package asks you to repair permissions/functions.
