...
Keep the `assets` folder as a folder. Do not move `styles.css`, `app.js`, or the other JavaScript files out of it. Every HTML page loads them from `assets/...`; moving them to the repository root will make the website appear unstyled, especially on phones.
